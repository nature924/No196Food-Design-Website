        ...
        <div class="content_c3">
            <div class="content_1">
                <div class="cookbook" style="display: block">
                    <div class="book1">
                        <div class="cook1"><p><i class="fa fa-search-plus"></i> 美食搜索结果</p></div>
                    </div>

                    <% if(request.getAttribute("food")==null)    //判断搜索结果是否存在
                    return;
                %>
                    <div class="book2">
                        <ul>
                            ...
                            <li class="cook2">
                                ...
                                <div class="cook22"style="margin-top: 0px">
                                    <div class="cook221" style="display: block">
                                        <p class="p1"><a href="">${food.name}</a></p>
                                    ...
                                    <div class="cook222">
                                        <ul>
                                            <li>
                                                ...
                                                <a href="${pageContext.request.contextPath}/findinfo?name=${food.name}">${food.way}</a></li>
                                            <li>
                                                <img src="images/wan/logo_1/log_12.png">
                                                <a href="${pageContext.request.contextPath}/make?name=${food.name}">${food.type}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </li>
