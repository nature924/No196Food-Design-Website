...
<div  style="margin:0px; padding:32px;background-color: #ffe4c4; height: 600px">
    <div style="width: 300px;height: 300px;margin: 20px auto;background: #ffe4c4" >
        <form action="register" method="post" onsubmit=" return checkAll()">
            <div class="form-group">
                ...
                <input id="name" type="text" class="form-control"  name="username" required placeholder="长度不能超过10个字符">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputSex" name="sex" required>
            </div>
            <div class="form-group">
                <label for="exampleInputAge">年龄</label>
                <span  id="numTip" style="color:red"></span>
                <input id="age" type="text" class="form-control" id="exampleInputAge" name="age" required placeholder="要介于1-100之间">
            </div>
            <div class="form-group">
                <label for="exampleInputWei">体重</label>
                <input type="text" class="form-control" id="exampleInputWei" name="weight" required>
            </div>
            <div class="form-group">
                <label for="exampleInputHeight">身高</label>
                <input type="text" class="form-control" id="exampleInputHeight" name="height" required>
            </div>
