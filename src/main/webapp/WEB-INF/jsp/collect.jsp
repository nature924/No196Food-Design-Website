...
<table class="table table-striped">
    ...
    <tbody>
<c:forEach items="${orderedFoods}" var="food">
    <tr>
        <th scope="row">${food.food_name}</th>
        <td>${food.date}</td>
        <td><a href="findinfo?name=${food.food_name}">查看</a></td>
        <td><a class="btn btn-danger" href="collectDel?food_name=${food.food_name}&user_name=${food.user_name}">
            <i class="fa fa-trash-o fa-lg"></i>删除</a></td>
    </tr>
</c:forEach>
    </tbody>
</table>
