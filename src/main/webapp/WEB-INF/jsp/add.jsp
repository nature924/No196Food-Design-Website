           ...
           <div style="margin: 30px auto; width: 400px;">
               <form action="add" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputImg" name="img" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputTime" class="col-sm-2 col-form-label">时间</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="inputPop" class="col-sm-2 col-form-label">热度</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPop" name="pop" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputWay" class="col-sm-2 col-form-label">方法</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputWay" name="way" required>
                    </div>
                </div>
                   <div class="form-group row">
                       <label for="inputCulture" class="col-sm-2 col-form-label">文化</label>
                       <div class="col-sm-10">
                           <input type="text" class="form-control" id="inputCulture" name="culture" required>
                       </div>
                   </div>
                   <div class="form-group row">
                       <label for="inputStep" class="col-sm-2 col-form-label">做法步骤</label>
                       <div class="col-sm-10">
                           <input type="text" class="form-control" id="inputStep" name="step" required>
                       </div>
                   </div>
                <div class="form-group row">
