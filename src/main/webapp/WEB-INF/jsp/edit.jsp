           ...
           <div style="margin: 30px auto; width: 400px;" >
               <form action="edit" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputTime" name="time" value="<%=food.getTime()%>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputType" class="col-sm-2 col-form-label" >类型</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputType" name="type" value="<%=food.getType()%>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputPop" class="col-sm-2 col-form-label" >热度</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPop" name="pop" value="<%=food.getPop()%>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="inputWay" class="col-sm-2 col-form-label" >方法</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputWay" name="way" value="<%=food.getWay()%>">
                    </div>
                </div>
                <div class="form-group row">
